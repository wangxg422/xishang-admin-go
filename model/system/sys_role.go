...
type SysRole struct {
	...
	RolePerms         string    `gorm:"column:role_perms" json:"rolePerms"`
	...
	SysMenus []SysMenu       `gorm:"many2many:sys_role_menu;foreignKey:RoleId;joinForeignKey:RoleId;references:MenuId;joinReferences:MenuId;" json:"menus,omitempty"`
	...
	SysPerms []SysPermission `gorm:"many2many:sys_role_permission;foreignKey:RoleId;joinForeignKey:RoleId;references:PermId;joinReferences:PermId;" json:"perms,omitempty"`
}
