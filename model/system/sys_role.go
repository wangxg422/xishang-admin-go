...
type SysRole struct {
	...
	SysPerms []SysRole `gorm:"many2many:sys_role_permission;foreignKey:RoleId;joinForeignKey:RoleId;references:PermId;joinReferences:PermId;" json:"perms,omitempty"`
}
